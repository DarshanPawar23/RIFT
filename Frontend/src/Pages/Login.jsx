  ...
  return (
    <div className="min-h-screen w-full flex relative overflow-hidden bg-black font-sans">
      ...
      <div className="relative w-full flex h-screen z-10">
        ...
        <div className="w-1/2 flex flex-col p-16 justify-between text-white bg-gradient-to-r from-black/80 to-transparent">
          ...
          <div className="max-w-xl animate-slide">
            ...
            <p className="text-xl text-gray-300 leading-relaxed font-light">
              Enter your credentials to resume your disciplined learning journey. Your AI tutor and playlist progress are waiting.
            </p>
        ...
        <div className="w-1/2 flex items-center justify-center p-12 bg-white/[0.03] backdrop-blur-2xl border-l border-white/10 shadow-2xl">
          <div className="w-full max-w-md space-y-10">
            <div className="space-y-2">
              <h2 className="text-5xl font-bold text-white tracking-tight">Student Login</h2>
              <p className="text-gray-400 text-lg font-light italic">Access your specialized learning ecosystem.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              >
                New student? <span className="text-red-500 font-bold border-b border-red-500/30 hover:border-red-500 pb-1">Join Fokusflow AI</span>
              </button>
            </form>
          </div>
        </div>
